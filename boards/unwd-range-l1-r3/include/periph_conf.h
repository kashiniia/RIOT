...
#define CLOCK_CORECLOCK     MHZ(32)             /* targeted core clock frequency */
#define CONFIG_BOARD_HAS_HSE        1
#define CONFIG_USE_CLOCK_PLL        1
/* configuration of PLL prescaler and multiply values */
/* CORECLOCK := HSI / CLOCK_PLL_DIV * CLOCK_PLL_MUL */
#define CONFIG_CLOCK_PLL_DIV       (3)
#define CONFIG_CLOCK_PLL_MUL       (4)

//#define CONFIG_CLOCK_PLL_DIV_HSI   (3)
//#define CONFIG_CLOCK_PLL_MUL_HSI   (6)

//#define CONFIG_CLOCK_PLL_DIV_HSE   (3)
//#define CONFIG_CLOCK_PLL_MUL_HSE   (4)
...
#define CONFIG_CLOCK_APB2_DIV      (1)     /* APB2 clock -> 32MHz */
#define CONFIG_CLOCK_APB1_DIV      (1)     /* APB1 clock -> 32MHz */
